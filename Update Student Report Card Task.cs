...
class StudentReportCard
{
    ...
    {
        Console.Write("Enter Total Students : 2");
        ...
        {
            Console.WriteLine("*********************************************");
            Console.Write("Enter Student Name : Lucy");
            students[i, 0] = Console.ReadLine();

            students[i, 1] = GetValidMarks("Enter English Marks (Out Of 100) : 50");
            students[i, 2] = GetValidMarks("Enter Math Marks (Out Of 100) : 60");
            students[i, 3] = GetValidMarks("Enter Computer Marks (Out Of 100) : 30");
        ...
        {
            Console.WriteLine("****************************************");
            Console.WriteLine($"Student Name: Bartolo{students[i, 0]}, Position: 2{i + 1}, Total: 160");
